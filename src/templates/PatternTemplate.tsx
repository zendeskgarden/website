...
import navigation from '../nav/patterns.yml';
import { IPageData, IPageContext } from './types';

const PatternLayoutTemplate: React.FC<PageProps<IPageData, IPageContext>> = ({
  children,
  data,
  pageContext
}) => {
  ...
  return (
    <RootLayout>
      <SEO
        title={`${pageContext.frontmatter.title} / Patterns`}
...
export default PatternLayoutTemplate;
