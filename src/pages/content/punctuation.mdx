...
_This plan affects any customers with 100–150 active agents._
...
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Breadcrumbs              | No. Bullets should be sentence fragments. If a bullet has more than one sentence, use closing punctuation on each. If a bullet has more than two sentences, it should be a description instead. |
| Bullets (in a list)      | No                                                                                                                                                                                              |
| Button                   | No                                                                                                                                                                                              |
