...
<Component components={props.data.mdx.subcomponents} componentName="tooltip.paragraph" />

<PropSheet components={props.data.mdx.subcomponents} componentName="tooltip.paragraph" />

#### Tooltip.Title

<Component components={props.data.mdx.subcomponents} componentName="tooltip.title" />

<PropSheet components={props.data.mdx.subcomponents} componentName="tooltip.title" />
