...
<Usage>
  ...
  <Misuse>
    <ul>
      <li>To display a list of actions use Split Button instead</li>
      <li>To help users navigate use Anchors instead</li>
      <li>To move between views use Tabs instead</li>
    </ul>
  </Misuse>
</Usage>
...
Items within a Menu can be disabled to limit a user from interacting with it.
