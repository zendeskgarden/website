...
<Usage>
  ...
  <Misuse>
    <ul>
      <li>
        <Markdown>
          To show a loading state, use the [Dots](/components/dots) loader instead
        </Markdown>
      </li>
    </ul>
  </Misuse>
...
<Component components={props.data.mdx.components} componentName="inline" />

Nest an Inline within a messaging context to signal activity of another party.
