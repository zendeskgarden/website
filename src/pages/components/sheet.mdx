...
<Sheet>
  <Sheet.Header>
    <Sheet.Title>{/* a text to label the sheet */}</Sheet.Title>
    <Sheet.Description>{/* a text describing the sheet */}</Sheet.Description>
  </Sheet.Header>

  <Sheet.Body>{/* main content of the sheet */}</Sheet.Body>

  <Sheet.Footer>
    <Sheet.FooterItem>{/* items to set in the footer, such as buttons */}</Sheet.FooterItem>
  </Sheet.Footer>
