...
<Usage>
  ...
  <Misuse>
    ...
    - To reference component styling values, use the context `theme` [API](/components/theme-provider#themeprovider) or `withTheme` [utility](/components/utilities#withtheme) instead
