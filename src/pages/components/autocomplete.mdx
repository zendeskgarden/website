...
Autocomplete expects the following overall structure:
...
The Autocomplete component applies state and a11y attributes to its children. It must be nested within a
Field component.
...
[Dropdown](/components/dropdowns) provides state and a11y through the context API to its consumers.
...
Field provides a11y attributes to child fields. It must wrap the Autocomplete component.
...
Provides a label for the dropdown field. Must be nested within a Field component.
...
[Menu](/components/menu) manages placement, positioning and layout of the child Item components.
