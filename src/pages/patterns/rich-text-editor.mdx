...
export const pageQuery = graphql`
  query ($slug: String) {
    ...SidebarPageFragment
    rteIntro: gardenFigmaAssets(name: { eq: "patterns-rich-text-editor-intro" }) {
      childFile {
        childImageSharp {
    ...
    rteAnatomy: gardenFigmaAssets(name: { eq: "patterns-rich-text-editor-anatomy" }) {
      childFile {
        childImageSharp {
          gatsbyImageData(height: 480)
        }
    ...
    rteExample: gardenFigmaAssets(name: { eq: "patterns-rich-text-editor-example" }) {
      childFile {
        childImageSharp {
          gatsbyImageData(height: 480)
        }
    ...
    rteToolbarSections: gardenFigmaAssets(
    ...
    rteToolbarSectionsCollapsedActions: gardenFigmaAssets(
    ...
    rteToolbarSectionsKeyboardShortcuts: gardenFigmaAssets(
    ...
    rteFormattingToolbarLocationStart: gardenFigmaAssets(
    ...
    rteFormattingToolbarLocationEnd: gardenFigmaAssets(
    ...
    rteFormattingToolbarLocationFloating: gardenFigmaAssets(
    ...
    rteFormattingToolbarLocationFloatingOpened: gardenFigmaAssets(
    ...
    rteFormattingToolbarSize: gardenFigmaAssets(
    ...
    rteFormattingResponsiveBehavior: gardenFigmaAssets(
    ...
    rteFormattingResponsiveBehaviorOverflow: gardenFigmaAssets(
    ...
    rteFormattingResizableTextarea: gardenFigmaAssets(
    ...
    rteFormattingResizableTextareaExpanded: gardenFigmaAssets(
    ...
    rteFormattingResizableTextareaScrollbar: gardenFigmaAssets(
    ...
    rteStatesDisabled: gardenFigmaAssets(
      name: { eq: "patterns-rich-text-editor-states-disabled" }
    ) {
      childFile {
        childImageSharp {
          gatsbyImageData(height: 480)
    ...
    rteFlowsInsertLinkSelect: gardenFigmaAssets(
    ...
    rteFlowsInsertLinkSave: gardenFigmaAssets(
    ...
    rteFlowsEditLinkSelect: gardenFigmaAssets(
    ...
    rteFlowsEditLinkSave: gardenFigmaAssets(
    ...
    rteAccessibilityManagingFocus: gardenFigmaAssets(
