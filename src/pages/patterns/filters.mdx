...
3. If filters are applied live, focus moves to close filter. Filter can also be closed with the `esc` key.
4. Focus moves to the first tag after container is closed.
